...
class PDFPreviewPage extends StatelessWidget {
  ...
  const PDFPreviewPage({super.key, required this.resumeData, required this.isDarkMode});
        ...
        build: (context) {
          return pw.Column(
            ...
            children: [
              ...
              if (resumeData.github.isNotEmpty) pw.Text('GitHub: ${resumeData.github}'),
              ...
              if (resumeData.positionsOfResponsibility.isNotEmpty) _buildPoRSection(),
              if (resumeData.extracurriculars.isNotEmpty) _buildExtracurricularSection(),
            ],
          );
        },
      ),
          ...
          pw.Column(
            ...
            children: [
              ...
              if (project.githubLink!.isNotEmpty)
                pw.Text('GitHub: ${project.githubLink}', style: const pw.TextStyle(fontSize: 12)),
  ...
  pw.Widget _buildPoRSection() {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        pw.Text('Positions of Responsibility', style: const pw.TextStyle(fontSize: 18)),
  ...
  pw.Widget _buildExtracurricularSection() {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        pw.Text('Extracurricular Activities', style: const pw.TextStyle(fontSize: 18)),
